...
const StatCard: Component<{
  ...
  <div class="rounded-xl border bg-card p-4 flex items-center gap-4 hover-lift">
    <div
      class={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${props.accent ?? 'bg-muted'}`}
    >
      <props.icon class="h-5 w-5" />
    </div>
    <div>
      <p class="text-2xl font-bold leading-none tabular-nums">{props.value}</p>
    ...
    <PageShell>
      <Show
        ...
        fallback={
          <div class="space-y-6">
            <div class="space-y-2">
              <Skeleton shape="text" width="60%" height="28px" />
              <Skeleton shape="text" width="40%" height="16px" />
            </div>
            <Skeleton shape="card" height="160px" />
            <div class="grid grid-cols-3 gap-3">
              <Skeleton shape="card" height="80px" />
              <Skeleton shape="card" height="80px" />
              <Skeleton shape="card" height="80px" />
            </div>
            <Skeleton shape="card" height="200px" />
          </div>
        }
      >
        <div class="space-y-6 animate-fade-in">
          ...
          >
            <div class="flex items-center gap-6">
              ...
              <div class="flex flex-col items-center gap-1 shrink-0">
                <div
                  class={`flex items-center justify-center h-16 w-16 rounded-2xl ${
                    streak() > 0
          ...
          >
            <EmptyState
              ...
              description="Create a class in the sidebar to start your study journey!"
